...
for epoch in range(0,EPOCHS):
    ...
    batched_fold_metadata = random_batch_df(fold_train_metadata, batch_size= 16)
        ...
        try:
            ...
            if step % 100 == 0:
                with training_summary_writer.as_default():
                    tf.summary.scalar('loss', loss_val.numpy(), step=step)
    ...
    with training_summary_writer.as_default():
        ...
        tf.summary.scalar('accuracy', training_acc[0].numpy(), step=step)
